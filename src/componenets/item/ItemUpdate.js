...
export default function ItemUpdate({ desc, takhfif, price, title, img, alt, href, product, id, stock }) {
    ...
    return (
        <Grid className={classes.itemDiv} >
            ...
            <Link href={href} className={classes.LinkDiv} style={{ textDecoration: 'none' }}>
